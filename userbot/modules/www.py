...
async def redis(pong):
    ...
    start = datetime.now()
    await pong.edit("__waiiittt.__")
    await pong.edit("__waittttt..__")
    await pong.edit("__waitttttt...__")
    await pong.edit("__waitttiiings....__")
